...
- **Aferição** — termo do AqDados para **calibração** de um canal. Dois modos: **por Regressão Linear** (ajusta uma reta a N pontos, reporta **correlação**) e **por Ganho e Ponto de Referência**. Refina o [ADR-006](docs/adr/006-calibracao-por-pontos.md).
