...
![Tests](https://img.shields.io/badge/testes-235%20passando-0A9EDC?logo=pytest&logoColor=white)
...
hardware presente — os 235 testes rodam em menos de um segundo.
...
- **Dependências opcionais de verdade.** `nidaqmx`, `openpyxl` e a GUI (`PySide6`/`pyqtgraph`) são
  extras; o pacote importa e os 235 testes rodam sem nenhum deles instalado.
...
simulados e no Mac com o adaptador sintético (235 testes). Em campo, o software **já leu o
